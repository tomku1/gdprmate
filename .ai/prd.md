...
- Opis: Jako zalogowany użytkownik, chcę móc wprowadzić tekst dokumentu (np. klauzuli informacyjnej) bezpośrednio do pola tekstowego w aplikacji, aby przeprowadzić jego analizę pod kątem zgodności z GDPR.
- Kryteria akceptacji:
    - W panelu użytkownika znajduje się wyraźnie widoczne pole tekstowe do wprowadzania tekstu.
    - Pole tekstowe jest odpowiednio duże, aby pomieścić typowy dokument.
    ...
    - System informuje o minimalnej i maksymalnej długości tekstu do analizy.
...
- Opis: Jako zalogowany użytkownik, po wprowadzeniu tekstu do pola tekstowego, chcę móc uruchomić proces analizy tego tekstu pod kątem zgodności z art. 7, 13 i 14 GDPR.
- Kryteria akceptacji:
    - Po wprowadzeniu tekstu widoczny jest przycisk "Analizuj".
    ...
    - Analizowany tekst jest zapisywany w historii użytkownika.
...
- Kryteria akceptacji:
    ...
    - Widok wyników jest powiązany z konkretnym analizowanym tekstem.

### US-006: Kopiowanie sugerowanych poprawek
