// Inline the GDPR reference text
const gdprReferenceText = `
...
^{2}This could include ticking a box when visiting an internet website, choosing technical settings for information society services or another statement or conduct which clearly indicates in this context the data subject's acceptance of the proposed processing of his or her personal data. ^{3}Silence, pre-ticked boxes or inactivity should not therefore constitute consent. ^{4}Consent should cover all processing activities carried out for the same purpose or purposes.  
^{5}When the processing has multiple purposes, consent should be given for all of them. ^{6}If the data subject's consent is to be given following a request by electronic means, the request must be clear, concise and not unnecessarily disruptive to the use of the service for which it is provided.  
...
^{3}Data subjects should have the opportunity to give their consent only to certain areas of research or parts of research projects to the extent allowed by the intended purpose.  
* This title is an unofficial description.
...
^{5}That information may be provided in combination with standardised icons in order to give in an easily visible, intelligible and clearly legible manner, a meaningful overview of the intended processing. ^{6}Where the icons are presented electronically, they should be machine-readable.  
* This title is an unofficial description.  

Recital 61 Time of Information*  
^{1}The information in relation to the processing of personal data relating to the data subject should be given to him or her at the time of collection from the data subject, or, where the personal data are obtained from another source, within a reasonable period, depending on the circumstances of the case. ^{2}Where personal data can be legitimately disclosed to another recipient, the data subject should be informed when the personal data are first disclosed to the recipient.  
^{3}Where the controller intends to process the personal data for a purpose other than that for which they were collected, the controller should provide the data subject prior to that further processing with information on that other purpose and other necessary information. ^{4}Where the origin of the personal data cannot be provided to the data subject because various sources have been used, general information should be provided.  
* This title is an unofficial description.  
...
^{2}The latter could in particular be the case where processing is carried out for archiving purposes in the public interest, scientific or historical research purposes or statistical purposes. ^{3}In that regard, the number of data subjects, the age of the data and any appropriate safeguards adopted should be taken into consideration.  
* This title is an unofficial description.  
...
/**
 * Gets the GDPR reference text.
 * The text is now hardcoded in this file.
 */
export function getGdprReferenceText(): string {
  // No async needed, return the hardcoded text
  return gdprReferenceText;
}
